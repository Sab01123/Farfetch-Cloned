...
function addToDetailPage(ele){
  ...
  window.location.href = "memproDetail.html"
}
...
function Versa(){
  ...
  let a = womens_Product.filter(function(ele){
    return ele.brand=="Bottega Veneta";
  })
...
function Versa3(){
  ...
  let a = womens_Product.filter(function(ele){
    return ele.brand=="Alexander McQueen";
  })
